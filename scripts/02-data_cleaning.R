#### Preamble ####
# Purpose: Cleans the raw GSS variables data
# Author: Wanling Ma
# Date: 12 March 2024
# Contact: wanling.ma@mail.utoronto.ca
# License: MIT
# Any other information needed? This is a script that generated by GSSDataExplorer
...
#### Save data ####
write_csv(GSS, "data/cleaned_data.csv")
